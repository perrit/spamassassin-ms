...
=item bayes_sql_master_dsn

bayes_sql_dsn DBI::databasetype:databasename:hostname:port

Used for BayesStore::PgSQL::Slave storage implementation.

This option give the connect string used to connect to the SQL based master Bayes storage.

=cut

  push (@cmds, {
    setting => 'bayes_sql_master_dsn',
    is_admin => 1,
    default => '',
    type => $CONF_TYPE_STRING,
  });
...
=item bayes_sql_master_username

Used by BayesStore::PgSQL::Slave storage implementation.

This option gives the username used by the master DSN. bayes_sql_username is
used in case this option is not configured.

=cut

  push (@cmds, {
    setting => 'bayes_sql_master_username',
    is_admin => 1,
    default => '',
    type => $CONF_TYPE_STRING,
  });
...
=item bayes_sql_master_password

Used by BayesStore::PgSQL::Slave storage implementation.

This option gives the password used by the master DSN. bayes_sql_password is
used in case this option is not configured.

=cut

  push (@cmds, {
    setting => 'bayes_sql_master_password',
    is_admin => 1,
    default => '',
    type => $CONF_TYPE_STRING,
  });
